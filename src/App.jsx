    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-grow flex items-start justify-center px-4 py-8">
        <div className="w-full max-w-5xl bg-white rounded-md shadow-sm overflow-hidden">
          ...
          {error && (
            <div className="p-4 bg-red-100 border-t border-red-400 text-red-700 font-bold">
              {error}
            </div>
          )}
        </div>
      </main>
      <footer className="items-center justify-centerbg-white border-t border-gray-200 mt-auto">
        <div className="max-w-5xl mx-auto px-4 py-3 text-sm text-headerColor">
          &copy; {new Date().getFullYear()} Projeto Tradutor Pessoal - Pedro S.
          Maia - Inspirado Por{" "}
          <a
